...
module.exports = {
    ...
    ImportSpecifier: Enum(['ImportNamedSpecifier', 'ImportDefaultSpecifier', 'ImportNamespaceSpecifier']),
    ...
    ExportSpecifier: Enum(['ExportNamespaceSpecifier', 'ExportDefaultSpecifier', 'ExportNamedSpecifier']),
    ...
    ExportDefaultDeclaration: Node({ decl: Enum(['ClassExpression', 'FunctionExpression', 'TsInterfaceDeclaration']) }),
