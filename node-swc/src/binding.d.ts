...
export function parseSyncToBufferViaPtr(src: string, opts: Buffer, filename?: string | undefined | null): Buffer
...
export function transformSyncFromBuffer(buff: Buffer, opts: Buffer): TransformOutput
